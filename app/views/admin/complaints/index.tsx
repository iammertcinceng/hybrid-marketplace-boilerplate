    ...
    <div className="space-y-4">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full sm:w-auto">
          ...
          <Button variant="outline" onClick={load} disabled={loading} className="w-full sm:w-auto sm:flex-shrink-0">
        ...
        items.map((r) => (
          <div key={r.id} className="border rounded-lg p-4 space-y-3">
            <div className="flex justify-between items-start">
              <div className="text-sm font-medium text-muted-foreground">#{r.id}</div>
              <StatusBadge value={r.status} />
            </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between">
                ...
                <span className="text-sm capitalize">{r.reportType === "message" ? "Mesaj" : "İlan"}</span>
              </div>
              
              <div className="flex justify-between items-start gap-2">
                <span className="text-sm font-medium text-muted-foreground min-w-fit">Neden:</span>
                <span className="text-sm break-words text-right">{r.reason}</span>
              </div>
              
              <div className="flex justify-between">
                <span className="text-sm font-medium text-muted-foreground">Raporlayan:</span>
                <Link className="text-sm text-primary font-medium hover:underline" href={r.reporterLink}>
                  {r.reporterUsername ?? r.reporterId}
                </Link>
              </div>
              
              <div className="flex justify-between">
                <span className="text-sm font-medium text-muted-foreground">Raporlanan:</span>
                <Link className="text-sm text-primary font-medium hover:underline" href={r.reportedLink}>
            ...
            <div className="flex gap-2 pt-2 border-t">
              <Link 
                className="inline-flex items-center justify-center text-primary underline underline-offset-1 font-medium px-3 py-2 rounded hover:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring flex-1 text-sm" 
                href={r.contentLink}
              >
                Detaya git
