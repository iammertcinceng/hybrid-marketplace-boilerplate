        ...
        <CardContent>
          <Tabs defaultValue="info" className="w-full">
            <TabsList className="grid w-full grid-cols-2">
              <TabsTrigger value="info" className="text-xs sm:text-sm">Kullanıcı Bilgileri</TabsTrigger>
              <TabsTrigger value="listings" className="text-xs sm:text-sm">İlanlar ({listings.length})</TabsTrigger>
            </TabsList>
                          ...
                          <div className="flex items-center justify-between gap-4">
                            <div className="flex-1">
                              <h3 className="font-medium">
                                <Link
                                  href={`/management/listing/${listing.id}`}
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <Button variant="outline" size="sm" asChild>
                                <Link href={`/management/listing/${listing.id}`}>
                                  İncele
                                </Link>
                              </Button>
                            </div>
