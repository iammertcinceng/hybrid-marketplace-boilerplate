  ...
  const columns = [
    {
      ...
      cell: ({ row }: { row: Row<User> }) => (
        <Button
          ...
          onClick={() => window.open(`/management/users/${row.original.id}`, "_blank")}
        >
  ...
  return (
    <div>
      ...
      <div className="mb-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <Select
          value={filters.hasListings}
          onValueChange={(value) =>
            setFilters((prev) => ({ ...prev, hasListings: value }))
          }
        >
          <SelectTrigger className="w-full focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            <SelectValue placeholder="İlan Durumu" />
          </SelectTrigger>
          <SelectContent>
