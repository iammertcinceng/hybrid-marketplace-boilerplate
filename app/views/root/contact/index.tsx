            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">{settings?.contact_email || "mertcin0@outlook.com"}</p>
                </div>
              </div>
              )}
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">{settings?.contact_phone || "+1 555 123 4567"}</p>
                </div>
              </div>
              )}
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">{settings?.contact_address || "123 Fake Street, CA 90210, USA"}</p>
                </div>
              </div>
              )}
            </CardContent>
