...
// import { FaGoogle } from "react-icons/fa";  FACEBOOK LOGİN DEVREDIŞI: FaFacebook importu devre dışı
  ...
  return (
    <>
      <div className="min-h-screen flex items-center justify-center">
        <Card className="glass-card w-full max-w-sm sm:w-[350px]">
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
        ...
        <div className="flex flex-row gap-2 my-2 w-full">
          ...
          {/* FACEBOOK LOGİN DEVREDIŞI: Facebook ile giriş butonu devre dışı */}
          {/**
          <Button
            type="button"
            variant="outline"
