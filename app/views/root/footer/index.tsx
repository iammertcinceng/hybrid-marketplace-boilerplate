    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto py-12 px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            {settings?.site_logo ? (
              <Image
                ...
                alt={settings?.site_name || "SaaS Boilerplate"}
                width={150}
                height={50}
              ...
              <h2 className="text-2xl font-bold text-white">
                {settings?.site_name || "SaaS Boilerplate"}
              </h2>
            )}
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/corporate" className="text-gray-400 hover:text-white transition-colors">
                  Kurumsal
                </Link>
              </li>
              <li>
                <Link href="/agreements" className="text-gray-400 hover:text-white transition-colors">
                  Sözleşmeler
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 text-center text-sm text-gray-400">
          <p>© {currentYear} {settings?.site_name || "SaaS Boilerplate"}. Tüm hakları saklıdır.</p>
        </div>
      </div>
    </footer>
  );
