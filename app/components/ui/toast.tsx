...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed z-[100] flex max-h-screen w-full flex-col-reverse p-2 sm:p-4 bottom-0 right-0 top-auto sm:bottom-8 sm:right-8 sm:top-auto sm:flex-col max-w-[50vw] sm:max-w-[320px]",
      className
    )}
    {...props}
  />
...
const toastVariants = cva(
  "group pointer-events-auto relative flex w-full items-center justify-between gap-2 sm:gap-4 overflow-hidden rounded-lg border p-2 sm:p-4 shadow-xl transition-all duration-300 ease-in-out " +
