...
export async function generateMetadata({
  ...
  try {
    ...
    const canonicalUrl = `https://mertcin.com/listing/${createSeoUrl(
      listing.title
    )}-${listing.id}`;
              ...
              ? [
                  {
                    ...
                    item: `https://mertcin.com/category/${parentCategory.slug}`,
                  },
                ]
              : []),
            {
              ...
              item: `https://mertcin.com/category/${category?.slug || ""}`,
            },
            {
              "@type": "ListItem",
              position: parentCategory ? 4 : 3,
              name: listing.title,
              item: `https://mertcin.com/listing/${createSeoUrl(
                listing.title
              )}-${listing.id}`,
            },
          ],
                    ...
                    {similarListingsResponse.listings
                      ...
                      .map((similarListing: any) => (
                        <Link
                          ...
                          href={`/listing/${createSeoUrl(similarListing.title)}-${
                            similarListing.id
                          }`}
                          className="group"
                        >
