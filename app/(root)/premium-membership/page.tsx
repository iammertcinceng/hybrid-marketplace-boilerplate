...
const PremiumUyelikPage = () => {
  ...
  return (
    <>
      <Head>
        <title>{showAsPremium ? 'Premium Üyelik Yönetimi' : 'Premium Üyelik Avantajları'} - SaaS Boilerplate</title>
        ...
        {showAsPremium ? (
          ...
          <div className="bg-gradient-to-br from-indigo-600 to-purple-600 text-white p-8 rounded-xl shadow-2xl">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
              ...
              <Link href="/add-listing" className="mt-4 md:mt-0 bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-bold py-3 px-6 rounded-lg shadow-md transition-transform transform hover:scale-105 flex items-center">
