...
export const metadata = {
  ...
  description: 'SaaS Boilerplate gizlilik politikası ve kişisel verilerin korunması hakkında bilgiler.',
};
  ...
  return (
    <div className="max-w-7xl mx-auto py-8 px-4 md:py-12">
      ...
      <p className="text-center text-muted-foreground max-w-2xl mx-auto mb-12">
        SaaS Boilerplate olarak kişisel verilerinizin korunması en önemli önceliklerimizden biridir. 
        ...
        <CardContent className="pt-6">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              ...
              mertcin0@outlook.com adresine e-posta gönderebilirsiniz.
            </p>
          </div>
        </CardContent>
      </Card>
