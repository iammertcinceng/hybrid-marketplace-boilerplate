...
export const metadata = {
  ...
  description: 'SaaS Boilerplate KVKK kapsamında kişisel verilerin işlenmesine ilişkin aydınlatma metni.',
};
  ...
  return (
    <div className="max-w-7xl mx-auto py-8 px-4 md:py-12">
      ...
      <p className="text-center text-muted-foreground max-w-2xl mx-auto mb-12">
        ...
        işlenmesine ilişkin SaaS Boilerplate olarak sizi bilgilendirmek istiyoruz.
      </p>
      ...
      <Card className="mb-8">
        <CardContent className="pt-6">
          ...
          <p className="text-muted-foreground">
            6698 sayılı Kişisel Verilerin Korunması Kanunu ("KVKK") uyarınca, SaaS Boilerplate 
      ...
      <Card className="mb-8">
        <CardContent className="pt-6">
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc pl-6 text-muted-foreground">
              <li>SaaS Boilerplate iş ortakları ve hizmet sağlayıcıları</li>
      ...
      <Card className="mb-8">
        <CardContent className="pt-6">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Bu haklarınızı kullanmak için, mertcin0@outlook.com adresine e-posta göndererek veya 
      ...
      <Card className="mb-8">
        <CardContent className="pt-6">
          ...
          <p className="text-muted-foreground">
            ...
            mertcin0@outlook.com e-posta adresi üzerinden bizimle iletişime geçebilirsiniz.
          </p>
        </CardContent>
      </Card>
