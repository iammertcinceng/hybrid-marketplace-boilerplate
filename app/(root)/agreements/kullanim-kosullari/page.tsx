...
export const metadata = {
  ...
  description: 'SaaS Boilerplate kullanım koşulları, kurallar ve şartlar hakkında bilgiler.',
};
  ...
  return (
    <div className="max-w-7xl mx-auto py-8 px-4 md:py-12">
      ...
      <p className="text-center text-muted-foreground max-w-2xl mx-auto mb-12">
        SaaS Boilerplate'nu kullanarak aşağıdaki koşulları kabul etmiş sayılırsınız. 
      ...
      <Card className="mb-8">
        <CardContent className="pt-6">
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              Bu Kullanım Koşulları, SaaS Boilerplate ("Platform", "biz", "bizim") ile Platform'u 
        ...
        <CardContent className="pt-6">
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              ...
              lütfen <a href="/agreements/gizlilik-politikasi" className="text-primary hover:underline">Gizlilik Politikası</a>'mızı 
              ve <a href="/agreements/kvkk" className="text-primary hover:underline">KVKK Aydınlatma Metni</a>'mizi inceleyiniz.
            </p>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="pt-6">
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              ...
              mertcin0@outlook.com e-posta adresi üzerinden veya İletişim sayfamız aracılığıyla bizimle iletişime geçiniz.
            </p>
          </div>
        </CardContent>
      </Card>
