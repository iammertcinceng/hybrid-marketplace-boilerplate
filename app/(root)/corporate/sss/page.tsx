...
export const metadata = {
  ...
  description: 'SaaS Boilerplate hakkında sıkça sorulan sorular ve cevapları.',
};
  ...
  const faqs = [
    {
      ...
      questions: [
        {
          question: 'SaaS Boilerplate nedir?',
          answer: 'SaaS Boilerplate, kullanıcıların çeşitli kategorilerde ilan paylaşabildiği ve keşfedebildiği online bir platformdur. Amacımız, kullanıcılarımızın ihtiyaçlarını karşılayacak ilanları kolaylıkla bulabilmelerini ve kendi ilanlarını güvenle paylaşabilmelerini sağlamaktır.'
        },
        {
          question: 'SaaS Boilerplate\'nu kullanmak ücretli midir?',
          answer: 'SaaS Boilerplate\'nda standart ilanlar ücretsiz olarak yayınlanabilir. Ancak, ilanlarınızın daha fazla kişiye ulaşmasını sağlamak için ücretli premium ilan seçeneklerimiz de bulunmaktadır. Ayrıca, yüksek üyelik paketlerimiz ile daha fazla özelliğe erişim sağlayabilirsiniz.'
        },
        {
          question: 'Hangi kategorilerde ilan verebilirim?',
          answer: 'SaaS Boilerplate\'nda emlak, araç, iş ilanları, hizmetler, ikinci el eşya gibi çeşitli kategorilerde ilanlar verebilirsiniz. Platformumuz sürekli olarak genişlemekte ve yeni kategoriler eklenmektedir.'
        }
      ]
    },
    {
  ...
  return (
    <div className="max-w-7xl mx-auto py-8 px-4 md:py-12">
      ...
      <p className="text-center text-muted-foreground max-w-2xl mx-auto mb-12">
        SaaS Boilerplate hakkında merak ettiğiniz soruların cevaplarını burada bulabilirsiniz.
      </p>
