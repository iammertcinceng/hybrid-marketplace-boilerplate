...
export const metadata = {
  title: 'Hakkımızda',
  description: 'SaaS Boilerplate olarak kim olduğumuz, vizyonumuz ve misyonumuz hakkında bilgi edinin.',
};
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
              ...
              <div className="md:w-2/3">
                ...
                <p className="text-muted-foreground mb-4">
                  SaaS Boilerplate olarak, 2024 yılında kurulmuş olan şirketimiz, kullanıcılarımıza çeşitli kategorilerde 
