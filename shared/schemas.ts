import {
  ...
  export const site_settings = pgTable("site_settings", {
    id: serial("id").primaryKey(),
    site_name: text("site_name").notNull().default("SaaS Boilerplate"),
    site_logo: text("site_logo"),
    site_favicon: text("site_favicon"),
    home_title: text("home_title").notNull().default("SaaS Boilerplate - İkinci El Alışveriş ve SaaS Boilerplate"),
    ...
    contact_email: text("contact_email").notNull().default("mertcin0@outlook.com"),
    contact_phone: text("contact_phone").notNull().default("+1 555 123 4567"),
    contact_address: text("contact_address").notNull().default("123 Fake Street, CA 90210, USA"),
    footer_text: text("footer_text").notNull().default("© 2024 SaaS Boilerplate. Tüm hakları saklıdır."),
